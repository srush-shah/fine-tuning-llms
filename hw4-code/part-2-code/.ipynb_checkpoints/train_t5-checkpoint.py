    ...
    with torch.no_grad():
        for batch in tqdm(dev_loader):
            ...
            generated = model.generate(
                ...
                decoder_start_token_id=tokenizer.encode("<extra_id_0>", add_special_tokens=False)[0],
            ...
            for gen_seq in generated:
                ...
                # Remove the <extra_id_0> prefix if present
                if decoded.startswith('<extra_id_0>'):
                    decoded = decoded[len('<extra_id_0>'):].strip()
